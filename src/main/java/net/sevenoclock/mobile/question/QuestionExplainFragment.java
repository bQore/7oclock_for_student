...
public class QuestionExplainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_question_explain, container, false);
    ...
    public static QuestionExplainFragment newInstance(int qid, String url) {
        QuestionExplainFragment view = new QuestionExplainFragment();
