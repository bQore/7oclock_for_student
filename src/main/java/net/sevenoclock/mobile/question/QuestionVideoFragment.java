...
public class QuestionVideoFragment extends Fragment {
    private Context con;
    private String url;
    ...
    public static QuestionVideoFragment newInstance(int qid, String url) {
        QuestionVideoFragment view = new QuestionVideoFragment();
