...
public class MainUnionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        options.round = 1000;
        Bitmap bitmap = values.aq.id(iv_main_union_list_icon).getCachedImage(Functions.DOMAIN + m_List.get(pos).get("icon", ""));
        ...
        tv_main_union_list_title.setText(m_List.get(pos).get("title", ""));
