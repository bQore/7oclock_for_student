...
public class MainActionbarView extends FrameLayout {
    ...
    public MainActionbarView(Context context) {
        ...
        values.aq.id(iv_main_actionbar_unionbtn).image(Functions.borderRadius(Functions.DOMAIN + values.union_info.get("icon",""), 100));
        iv_main_actionbar_unionbtn.setVisibility(View.GONE);
