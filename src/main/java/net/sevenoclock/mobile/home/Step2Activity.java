    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_home_step2_submit:
                ...
                if(!grade_code.startsWith("n")){
                    if(school_id == 0)Toast.makeText(this,"학교를 지정해주세요!", Toast.LENGTH_SHORT).show();
                    else params.put("school_id", school_id);
                }
