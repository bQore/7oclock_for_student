...
public class SignupActivity extends Activity implements View.OnClickListener {
    ...
    public void onPause(){
        ...
        IBinder now_focus = getCurrentFocus().getApplicationWindowToken();
        // 키보드 감춤
        input_manager.hideSoftInputFromWindow(now_focus, 0);
        super.onPause();
    }
